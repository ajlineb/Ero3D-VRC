...
export default function Collections() {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Ero3D - Collections</title>
        <link rel="" href="https://ero3dvrc.onrender.com/collections" />
      </Helmet>
        ...
        <div className="rightInfo container">
          ...
          <div className="flex flex-col justify-evenly">
            ...
            <p className="text-justify">
              ...
              From sculpting body parts, to resizing, to adding all covered
              here!
            </p>
            <br className="m-5" />
            <p className="text-justify">
            ...
            <p className="text-justify">
              ...
              Want the EroChi model? Will include clothing, shapekeys for
              toggling breasts, textures included and AO, and Unity project for
              easy start with animations.
            </p>
            <br className="m-5" />
            <p className="text-justify">
              <span className="font-black works-info">Custom Hair: </span>
              Able to make hair from scratch, add bones and weight paint. UVs
              will be setup too for textures.
            </p>
            <br className="m-5" />
            <p className="text-justify ">
              <span className="font-black works-info">
