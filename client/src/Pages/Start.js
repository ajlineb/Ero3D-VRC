...
export default function Start() {
  ...
  return (
    <>
      <Helmet>
        <meta charSet="utf-8" />
        <title>Ero3D - Start</title>
        <link rel="" href="https://ero3dvrc.onrender.com/" />
      </Helmet>
      <div className="content grid grid-cols-1 lg:grid-cols-1 gap-4 lg:gap-8 font-mono">
        <div className="centerInfo container">
          ...
          <p>
            ...
            creation here. If you would like to get in touch about an avatar
            idea or edits to your current model let me know!
          </p>
        </div>
